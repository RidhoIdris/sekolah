...
<div class="modal fade" id="modal" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            <form method="POST" id="formGuru" action="{{ route('masterGuru.store')}}">
                <fieldset>
                @csrf
                <div class="row">
                    <div class="form-group col-6">
                        <input type="text" autocomplete="off" class="form-control" placeholder="Nomor Induk Pegawai" name="nip">
                    </div>
                    <div class="form-group col-6">
                        <input type="text" autocomplete="off" class="form-control" placeholder="Nama Guru" name="nama_guru">
                    </div>
                    <div class="form-group col-6">

                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-right">
                                <ul class="list-unstyled card-option">
                                    <li><button id="tambah" class="btn btn-success btn-sm">Tambah Guru</button></li>
                                </ul>
                            </div>
                        </div>
...
$(document).ready(function() {
    var getData = $('#guru').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('masterGuru.show') }}",
        columns: [
    ...
    $('#tambah').click(function(){
        $('.modal-header h4').text('Tambah Guru');
    ...
    $(document).on('click','#edit',function(){
        ...
        $.ajax({
            ...
            headers: {
                ...
                $('input[name="nama_guru"]').val(data.nama_guru);
